...
file_internal void Win32ThreadPoolInit(Win32ThreadPool **result, i32 thread_count, i32 queue_max)
{
    Win32ThreadPool *pool = (Win32ThreadPool*)MemAlloc(sizeof(Win32ThreadPool));
    pool->thread_count = thread_count;
    pool->queue_size = queue_max;
    pool->head = pool->tail = pool->count = 0;
    pool->started = pool->shutdown = 0;
    pool->threads = (HANDLE*)MemAlloc(sizeof(HANDLE) * pool->thread_count);
    pool->tasks = (Win32ThreadPoolTask*)MemAlloc(sizeof(Win32ThreadPoolTask) * pool->queue_size);
