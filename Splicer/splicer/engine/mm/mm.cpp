...
void *talloc(size_t size) {
    return jengine::mm::jalloc(size, jengine::mm::MEMORY_REQUEST_TRANSIENT_STORAGE);
}

void *palloc(size_t size) {
    //return malloc(size);
    return jengine::mm::jalloc(size, jengine::mm::MEMORY_REQUEST_PERMANANT_STORAGE);
}

void *prealloc(void *src, size_t size)
{
    return jengine::mm::jrealloc(src, size, jengine::mm::MEMORY_REQUEST_PERMANANT_STORAGE);
}


void *trealloc(void *src, size_t size)
{
    return jengine::mm::jrealloc(src, size, jengine::mm::MEMORY_REQUEST_TRANSIENT_STORAGE);
}
