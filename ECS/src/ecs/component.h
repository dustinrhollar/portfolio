...
extern GUID STATIC_COMPONENT_GUID;
// Generate an id for a new type of component
template<class T>
GUID GenerateNewComponentID()
{
...
{
    public:
    GUID GetStaticId() {return STATIC_COMPONENT_ID;}
    static const GUID STATIC_COMPONENT_ID;
};

template<class T>
const GUID Component<T>::STATIC_COMPONENT_ID = GenerateNewComponentID<T>();  
...
template<class T>
void AddEntityToComponent(Entity entity, void *data)
{
    AddEntityToComponent(Component<T>::STATIC_COMPONENT_ID, entity, data, sizeof(T));
