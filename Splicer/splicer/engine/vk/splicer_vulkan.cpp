...
file_internal bool CreateInstance()
{
    ...
    appInfo.pApplicationName   = "Splicer";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName        = "Jackal";
    ...
    const char* plat_exts = Platform.GetRequiredInstanceExtensions(GlobalEnabledValidationLayers);
...
file_internal void CreateSwapchain(SwapChainParameters &swapchain_params)
{
    ...
    VkExtent2D extent;
    {
        ...
        {
            int width, height;
            Platform.GetClientWindowDimensions(&width, &height);
...
bool vk::InitializeVulkan()
{
    ...
    Platform.CreateSurface(&GlobalVulkanState.PresentationSurface, GlobalVulkanState.Instance);
    ...
    jengine::mm::Allocator *GlobalPermanantStorage = jengine::mm::GetPermanantStorage();
    ...
    vmaf.vkGetBufferMemoryRequirements2KHR;
    vmaf.vkGetImageMemoryRequirements2KHR;
#endif
#if VMA_BIND_MEMORY2 || VMA_VULKAN_VERSION >= 1001000
    vmaf.vkBindBufferMemory2KHR;
    vmaf.vkBindImageMemory2KHR;
#endif
#if VMA_MEMORY_BUDGET || VMA_VULKAN_VERSION >= 1001000
    vmaf.vkGetPhysicalDeviceMemoryProperties2KHR;
#endif
