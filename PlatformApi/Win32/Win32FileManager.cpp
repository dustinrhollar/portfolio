...
file_internal void Win32FilePoolAlloc(Win32FilePool *pool, File **File);
...
{
    pool->handles = 0;
    arrsetcap(pool->handles, MAX_FILE_COUNT);
...
file_internal void 
Win32FilePoolAlloc(Win32FilePool *pool, File **File)
{
    *file = 0;
